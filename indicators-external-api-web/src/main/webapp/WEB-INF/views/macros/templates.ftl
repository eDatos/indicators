	...
	<body>
		<div id="principal_interior">
			<div id="cabecera">
				<div id="cab_superior">
					<ul>
						<li><a href="http://www.gobiernodecanarias.org/istac/herramientas/rss.html" accesskey="r" title="Rich Site Summary (RSS) (tecla de acceso: r)"><img height="14" width="14" style="vertical-align: text-bottom; float: none;" src="${indicatorsExternalApiUrlBase}/theme/images/atom.png" title="RSS" alt="RSS" /> RSS</a></li>
						<li>|</li>
			...
			<div id="bloq_interior">
			   ...
			   <div id="pie">
				...
				<div class="dcha">
					<a href="http://www.gobiernodecanarias.org/istac/Open-Definition.html" target="_blank"><img alt="Open Data" height="13px" src="${indicatorsExternalApiUrlBase}/theme/images/opendata_80x15_black.png" />
