...
templates['resource'] = template(function (Handlebars,depth0,helpers,partials,data) {
  ...
  buffer += escapeExpression(stack1) + "');\">Mostrar/Ocultar</a>\n        </li>\n        <li>\n            <a href='#' onclick=\"Docs.collapseOperationsForResource('";
  foundHelper = helpers.name;
  if (foundHelper) { stack1 = foundHelper.call(depth0, {hash:{}}); }
  else { stack1 = depth0.name; stack1 = typeof stack1 === functionType ? stack1() : stack1; }
...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.getSignature = function(dataType, models) {
    ...
    OperationView.prototype.getResponseClassSignature = function() {
      var dataType, isPrimitive, listType, models;
      models = this.model.resource.models;
      dataType = this.model.responseClass;
      listType = this.model.isListType(dataType);
      isPrimitive = ((listType != null) && models[listType]) || (models[dataType] != null) ? false : true;
      if (isPrimitive) {
        return dataType;
      } else {
    ...
    OperationView.prototype.render = function() {
      ...
      if (this.model.responseClassSignature && this.model.responseClassSignature !== 'string') {
        signatureModel = {
          ...
          isParam: false,
          signature: this.getResponseClassSignature()
        };
