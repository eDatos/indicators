...
import es.gobcan.istac.indicators.rest.test.mocks.OperationBaseMock;
...
@ContextConfiguration(
        ...
        locations = {
            "/spring/indicators-rest-applicationContext-test-web.xml",
            "/spring/indicators-rest-applicationContext-test.xml",
...
public class IndicatorSystemTestRestService {
    ...
    public void initMocks() throws Exception {
        ...
        when(statisticalOperations.retrieveOperation(eq("CODIGO_0001"))).thenReturn(OperationBaseMock.mockOperationBase1());
...
//        when(metamacStatisticalOperationsExternalInterfaceV10.retrieveOperation(OperationBaseMock.mockOperationBase2().getCode())).thenReturn(OperationBaseMock.mockOperationBase2());
    ...
    public void findIndicatorsSystyems() throws Exception {
        ...
        resultActions.andExpect(jsonPath("$[0].code", equalTo(OperationBaseMock.mockOperationBase1().getCode())));
        resultActions.andExpect(jsonPath("$[1]").exists());
        resultActions.andExpect(jsonPath("$[1].code", equalTo(OperationBaseMock.mockOperationBase2().getCode())));
