...
public class IndicatorInstancesRest2DoMapperImpl implements IndicatorInstancesRest2DoMapper {
    ...
    public IndicatorInstancesRest2DoMapperImpl() {
        parser = new RestCriteria2SculptorCriteria<IndicatorInstance>(
                IndicatorInstance.class,
                IndicatorInstancesPropertyOrder.class,
                IndicatorInstancesPropertyRestriction.class, new IndicatorInstancesCriteriaCallback());
    }
    ...
    private class IndicatorInstancesCriteriaCallback implements RestCriteria2SculptorCriteria.CriteriaCallback {
            ...
            switch (propertyNameCriteria) {
                ...
                case id : {
                    if(propertyRestriction.getValue() != null) {
                        return new SculptorPropertyCriteria(IndicatorInstanceProperties.code(), propertyRestriction.getValue());
                    } else if(propertyRestriction.getValueList() != null) {
                        List<Object> valueList = new ArrayList<Object>(propertyRestriction.getValueList());
                        return new SculptorPropertyCriteria(IndicatorInstanceProperties.code(), valueList);
                    }
                }

                case geographicalValue: {
                    return new SculptorPropertyCriteria(IndicatorInstanceProperties.lastValuesCache().geographicalValue().code(), value);
                }
        ...
        public Property retrievePropertyOrder(MetamacRestOrder order) throws RestException {
            ...
            switch (propertyNameCriteria) {
                case update: {
                    return new LeafProperty<IndicatorInstance>(IndicatorInstanceProperties.lastUpdated().getName(),
