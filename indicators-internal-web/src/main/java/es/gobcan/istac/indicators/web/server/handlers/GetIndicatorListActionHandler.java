...
@Component
public class GetIndicatorListActionHandler extends SecurityActionHandler<GetIndicatorListAction, GetIndicatorListResult> {
    ...
    @Override
    public GetIndicatorListResult executeSecurityAction(GetIndicatorListAction action) throws ActionException {
        try {
