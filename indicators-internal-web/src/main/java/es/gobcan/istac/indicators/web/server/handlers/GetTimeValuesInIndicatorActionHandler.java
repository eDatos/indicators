...
@Component
public class GetTimeValuesInIndicatorActionHandler extends SecurityActionHandler<GetTimeValuesInIndicatorAction, GetTimeValuesInIndicatorResult> {
    ...
    @Override
    public GetTimeValuesInIndicatorResult executeSecurityAction(GetTimeValuesInIndicatorAction action) throws ActionException {
        try {
