...
public class ModalWindow {
    ...
    /**
     * Creates a new {@link ModalWindow} given the canvas to be masked (an {@link Canvas#addChild(Canvas)} will be called to add the masking layer
     ...
     * 
     * @param loadingIcon
     *            icon URL of new image icon. Default value is <blockquote> " {@link Page#getSkinImgDir()}/loading.gif "
     */
