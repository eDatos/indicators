...
@Component
public class GetDataSourcesListActionHandler extends SecurityActionHandler<GetDataSourcesListAction, GetDataSourcesListResult> {
    ...
    @Override
    public GetDataSourcesListResult executeSecurityAction(GetDataSourcesListAction action) throws ActionException {
        try {
