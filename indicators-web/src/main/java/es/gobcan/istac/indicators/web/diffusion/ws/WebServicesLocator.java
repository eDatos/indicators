...
public class WebServicesLocator {
    ...
    public void initService() throws Exception {
        metamacStatisticalOperationInternalEndpoint = configurationService.getProperties().getProperty(WebConstants.METAMAC_STATISTICAL_OPERATIONS_INTERNAL_ENDPOINT_ADDRESS_PROPERTY);
