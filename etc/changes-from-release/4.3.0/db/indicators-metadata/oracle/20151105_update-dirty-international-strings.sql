...
where loc.ID in (select loc.ID as LOCALISED_STRING_ID
...
set TITLE_FK = null
where indver.TITLE_FK in (select ins.ID
...
update TB_INDICATORS_VERSIONS indver
set ACRONYM_FK = null
where indver.ACRONYM_FK in (select ins.ID
                            from TB_INTERNATIONAL_STRINGS ins
                            where ins.ID NOT IN (select loc.INTERNATIONAL_STRING_FK
                                                from TB_LOCALISED_STRINGS loc));
...
where indver.SUBJECT_TITLE_FK in (select ins.ID
                            from TB_INTERNATIONAL_STRINGS ins
                            where ins.ID NOT IN (select loc.INTERNATIONAL_STRING_FK
                                                from TB_LOCALISED_STRINGS loc));
...
where indver.CONCEPT_DESCRIPTION_FK in (select ins.ID
                            from TB_INTERNATIONAL_STRINGS ins
                            where ins.ID NOT IN (select loc.INTERNATIONAL_STRING_FK
                                                from TB_LOCALISED_STRINGS loc));
...
where indver.COMMENTS_FK in (select ins.ID
                            from TB_INTERNATIONAL_STRINGS ins
                            where ins.ID NOT IN (select loc.INTERNATIONAL_STRING_FK
                                                from TB_LOCALISED_STRINGS loc));
...
update TB_INDICATORS_VERSIONS indver
set NOTES_FK = null
where indver.NOTES_FK in (select ins.ID
                            from TB_INTERNATIONAL_STRINGS ins
                            where ins.ID NOT IN (select loc.INTERNATIONAL_STRING_FK
                                                from TB_LOCALISED_STRINGS loc));
...
where indver.PERCENTAGE_OF_FK in (select ins.ID
                            from TB_INTERNATIONAL_STRINGS ins
                            where ins.ID NOT IN (select loc.INTERNATIONAL_STRING_FK
                                                from TB_LOCALISED_STRINGS loc));
...
where indver.SOURCE_SURVEY_TITLE_FK in (select ins.ID
                            from TB_INTERNATIONAL_STRINGS ins
                            where ins.ID NOT IN (select loc.INTERNATIONAL_STRING_FK
                                                from TB_LOCALISED_STRINGS loc));
...
where indver.SOURCE_SURVEY_ACRONYM_FK in (select ins.ID
                            from TB_INTERNATIONAL_STRINGS ins
                            where ins.ID NOT IN (select loc.INTERNATIONAL_STRING_FK
                                                from TB_LOCALISED_STRINGS loc));
...
where indver.TITLE_SUMMARY_FK in (select ins.ID
                            from TB_INTERNATIONAL_STRINGS ins
                            where ins.ID NOT IN (select loc.INTERNATIONAL_STRING_FK
                                                from TB_LOCALISED_STRINGS loc));
