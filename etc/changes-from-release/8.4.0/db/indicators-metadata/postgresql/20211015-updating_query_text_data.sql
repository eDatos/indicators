...
-- 5. Generar las sentencias sql update de los registros a actualizar del paso 2 con el sql CONSULTA 4.
-- 6. Generar las sentencias sql update de los registros a actualizar del paso 3 con el sql CONSULTA 5.
