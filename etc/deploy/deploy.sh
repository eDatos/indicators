...
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" indicators-internal-web/target/indicators-internal-*.war deploy@192.168.10.16:$TRANSFER_PATH/indicators-internal.war
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" indicators-web/target/indicators-*.war deploy@192.168.10.16:$TRANSFER_PATH/indicators-visualizations.war
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" indicators-external-api-web/target/indicators-*.war deploy@192.168.10.16:$TRANSFER_PATH/indicators.war
