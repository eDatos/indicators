...
INSERT INTO TB_LIS_QUANTITIES_UNITS (ID, UUID, SYMBOL, SYMBOL_POSITION, TITLE_FK, VERSION) values (SEQ_QUANTITIES_UNITS.nextval, '1', 'km', 'END', SEQ_I18NSTRS.currval, 0);
...
INSERT INTO TB_LIS_QUANTITIES_UNITS (ID, UUID, SYMBOL, SYMBOL_POSITION, TITLE_FK, VERSION) values (SEQ_QUANTITIES_UNITS.nextval, '2', 'm', 'END', SEQ_I18NSTRS.currval, 0);
