...
INSERT INTO TB_LIS_GEOGR_GRANULARITIES (ID, CODE, UUID, TITLE_FK) values (SEQ_GEOGR_GRANULARITIES.nextval, 'REGIONS', '2', SEQ_I18NSTRS.currval);
	...
	INSERT INTO TB_INTERNATIONAL_STRINGS (ID, VERSION) values (Seq_I18nstrs.Nextval, 1);
	INSERT INTO TB_LOCALISED_STRINGS (ID, LABEL, LOCALE, INTERNATIONAL_STRING_FK, VERSION) values (SEQ_L10NSTRS.NEXTVAL, ' ANDALUC�?A', 'en', Seq_I18nstrs.Currval, 1);
	INSERT INTO TB_LOCALISED_STRINGS (ID, LABEL, LOCALE, INTERNATIONAL_STRING_FK, VERSION) values (SEQ_L10NSTRS.NEXTVAL, ' ANDALUC�?A', 'es', Seq_I18nstrs.Currval, 1);
	...
	INSERT INTO TB_INTERNATIONAL_STRINGS (ID, VERSION) values (Seq_I18nstrs.Nextval, 1);
	INSERT INTO TB_LOCALISED_STRINGS (ID, LABEL, LOCALE, INTERNATIONAL_STRING_FK, VERSION) values (SEQ_L10NSTRS.NEXTVAL, ' PA�?S VASCO', 'en', Seq_I18nstrs.Currval, 1);
	INSERT INTO TB_LOCALISED_STRINGS (ID, LABEL, LOCALE, INTERNATIONAL_STRING_FK, VERSION) values (SEQ_L10NSTRS.NEXTVAL, ' PA�?S VASCO', 'es', Seq_I18nstrs.Currval, 1);
...
INSERT INTO TB_LIS_GEOGR_GRANULARITIES (ID, CODE, UUID, TITLE_FK) values (SEQ_GEOGR_GRANULARITIES.nextval, 'PROVINCES', '3', SEQ_I18NSTRS.currval);
	...
	INSERT INTO TB_INTERNATIONAL_STRINGS (ID, VERSION) values (Seq_I18nstrs.Nextval, 1);
	INSERT INTO TB_LOCALISED_STRINGS (ID, LABEL, LOCALE, INTERNATIONAL_STRING_FK, VERSION) values (SEQ_L10NSTRS.NEXTVAL, '  �?vila', 'en', Seq_I18nstrs.Currval, 1);
	INSERT INTO TB_LOCALISED_STRINGS (ID, LABEL, LOCALE, INTERNATIONAL_STRING_FK, VERSION) values (SEQ_L10NSTRS.NEXTVAL, '  �?vila', 'es', Seq_I18nstrs.Currval, 1);
	...
	INSERT INTO TB_INTERNATIONAL_STRINGS (ID, VERSION) values (Seq_I18nstrs.Nextval, 1);
	INSERT INTO TB_LOCALISED_STRINGS (ID, LABEL, LOCALE, INTERNATIONAL_STRING_FK, VERSION) values (SEQ_L10NSTRS.NEXTVAL, '  �?lava', 'en', Seq_I18nstrs.Currval, 1);
	INSERT INTO TB_LOCALISED_STRINGS (ID, LABEL, LOCALE, INTERNATIONAL_STRING_FK, VERSION) values (SEQ_L10NSTRS.NEXTVAL, '  �?lava', 'es', Seq_I18nstrs.Currval, 1);
