...
DROP TABLE TBL_INDICATOR_SYSTEM_VERS CASCADE CONSTRAINTS PURGE;
...
CREATE TABLE TBL_INDICATOR_SYSTEM_VERS (
  ID NUMBER(19) NOT NULL,
  ...
  INDICATOR_SYTEM_FK NUMBER(19) NOT NULL,
...
ALTER TABLE TBL_INDICATOR_SYSTEM_VERS ADD CONSTRAINT PK_TBL_INDICATOR_SYSTEM_VERS
	PRIMARY KEY (ID)
;
...
ALTER TABLE TBL_INDICATOR_SYSTEM_VERS
    ADD CONSTRAINT UQ_TBL_INDICATOR_SYSTEM_VERS UNIQUE (UUID)
;
...
ALTER TABLE TBL_INDICATOR_SYSTEM_VERS ADD CONSTRAINT FK_TBL_INDICATOR_SYSTEM_VERS80
	FOREIGN KEY (TITLE_FK) REFERENCES TBL_INTERNATIONAL_STRINGS (ID)
;
ALTER TABLE TBL_INDICATOR_SYSTEM_VERS ADD CONSTRAINT FK_TBL_INDICATOR_SYSTEM_VERS71
	FOREIGN KEY (ACRONYM_FK) REFERENCES TBL_INTERNATIONAL_STRINGS (ID)
;
ALTER TABLE TBL_INDICATOR_SYSTEM_VERS ADD CONSTRAINT FK_TBL_INDICATOR_SYSTEM_VERS98
	FOREIGN KEY (OBJETIVE_FK) REFERENCES TBL_INTERNATIONAL_STRINGS (ID)
;
ALTER TABLE TBL_INDICATOR_SYSTEM_VERS ADD CONSTRAINT FK_TBL_INDICATOR_SYSTEM_VERS04
	FOREIGN KEY (DESCRIPTION_FK) REFERENCES TBL_INTERNATIONAL_STRINGS (ID)
;
ALTER TABLE TBL_INDICATOR_SYSTEM_VERS ADD CONSTRAINT FK_TBL_INDICATOR_SYSTEM_VERS54
	FOREIGN KEY (INDICATOR_SYTEM_FK) REFERENCES TBL_INDICATORS_SYSTEMS (ID)
;

  
ALTER TABLE TBL_INDICATORS_SYSTEMS ADD CONSTRAINT FK_TBL_INDICATORS_SYSTEMS_DR52
	FOREIGN KEY (DRAFT_FK) REFERENCES TBL_INDICATOR_SYSTEM_VERS (ID)
;
ALTER TABLE TBL_INDICATORS_SYSTEMS ADD CONSTRAINT FK_TBL_INDICATORS_SYSTEMS_PU67
	FOREIGN KEY (PUBLISHED_FK) REFERENCES TBL_INDICATOR_SYSTEM_VERS (ID)
;
