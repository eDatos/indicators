...
CREATE TABLE TBL_INDICATORS_INSTANCES (
  ...
  TITLE_FK NUMBER(19) NOT NULL,
  INDICATOR_FK NUMBER(19) NOT NULL,
  TEMPORARY_GRANULARITY VARCHAR2(40)
);
...
ALTER TABLE LIS_QUANTITIES_UNITS ADD CONSTRAINT FK_LIS_QUANTITIES_UNITS_TEXT02
	FOREIGN KEY (TEXT_FK) REFERENCES TBL_INTERNATIONAL_STRINGS (ID)
;
