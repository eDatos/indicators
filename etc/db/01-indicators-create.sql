...
CREATE TABLE TBL_DATA_SOURCE_VARIABLES (
  ID NUMBER(19) NOT NULL,
...
CREATE TABLE TBL_INDICATOR_INSTANCES (
  ID NUMBER(19) NOT NULL,
  INDICATOR_UUID VARCHAR2(100) NOT NULL,
  ORDER_IN_LEVEL NUMBER(19) NOT NULL,
  UUID VARCHAR2(36) NOT NULL,
  CREATED_DATE_TZ VARCHAR2(50),
  CREATED_DATE TIMESTAMP,
  ...
  LAST_UPDATED_BY VARCHAR2(50),
  VERSION NUMBER(19) NOT NULL,
  INDICATORS_SYSTEM_VERSION_FK NUMBER(19) NOT NULL,
...
ALTER TABLE TBL_DATA_SOURCE_VARIABLES ADD CONSTRAINT PK_TBL_DATA_SOURCE_VARIABLES
	PRIMARY KEY (ID)
;
...
ALTER TABLE TBL_INDICATOR_INSTANCES ADD CONSTRAINT PK_TBL_INDICATOR_INSTANCES
	PRIMARY KEY (ID)
;
...
ALTER TABLE TBL_DATA_SOURCE_VARIABLES
    ADD CONSTRAINT UQ_TBL_DATA_SOURCE_VARIABLES UNIQUE (UUID)
;
...
ALTER TABLE TBL_INDICATOR_INSTANCES
    ADD CONSTRAINT UQ_TBL_INDICATOR_INSTANCES UNIQUE (UUID)
;
...
;
ALTER TABLE TBL_INDICATOR_VERSIONS ADD CONSTRAINT FK_TBL_INDICATOR_VERSIONS_CO68
	FOREIGN KEY (COMMENTARY_FK) REFERENCES TBL_INTERNATIONAL_STRINGS (ID)
;
ALTER TABLE TBL_INDICATOR_VERSIONS ADD CONSTRAINT FK_TBL_INDICATOR_VERSIONS_NO78
...
ALTER TABLE TBL_DATA_SOURCES ADD CONSTRAINT FK_TBL_DATA_SOURCES_INDICATO27
	FOREIGN KEY (INDICATOR_VERSION_FK) REFERENCES TBL_INDICATOR_VERSIONS (ID)
;

ALTER TABLE TBL_DATA_SOURCE_VARIABLES ADD CONSTRAINT FK_TBL_DATA_SOURCE_VARIABLES36
...
ALTER TABLE TBL_INDICATOR_INSTANCES ADD CONSTRAINT FK_TBL_INDICATOR_INSTANCES_I53
	FOREIGN KEY (INDICATORS_SYSTEM_VERSION_FK) REFERENCES TBL_INDIC_SYSTEMS_VERSIONS (ID)
;
ALTER TABLE TBL_INDICATOR_INSTANCES ADD CONSTRAINT FK_TBL_INDICATOR_INSTANCES_D08
