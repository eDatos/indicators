...
CREATE TABLE TBL_INDIC_SYSTEMS_VERSIONS (
  ...
  INDICATORS_SYTEM_FK NUMBER(19) NOT NULL,
...
;
ALTER TABLE TBL_INDIC_SYSTEMS_VERSIONS ADD CONSTRAINT FK_TBL_INDIC_SYSTEMS_VERSION37
	FOREIGN KEY (INDICATORS_SYTEM_FK) REFERENCES TBL_INDICATORS_SYSTEMS (ID)
;
