...
CREATE TABLE TBL_DATA_SOURCES (
  ...
  TEMPORAL_VARIABLE VARCHAR2(100) NOT NULL,
...
CREATE TABLE TBL_INDICATORS_INSTANCES (
  ID NUMBER(19) NOT NULL,
  TEMPORAL_VALUE VARCHAR2(100),
  GEOGRAPHICAL_GRANULARITY_ID VARCHAR2(100),
  GEOGRAPHICAL_VALUE VARCHAR2(100),
  UUID VARCHAR2(36) NOT NULL,
  CREATED_DATE_TZ VARCHAR2(50),
  CREATED_DATE TIMESTAMP,
  CREATED_BY VARCHAR2(50),
  ...
  TITLE_FK NUMBER(19) NOT NULL,
  INDICATOR_FK NUMBER(19) NOT NULL,
  TEMPORAL_GRANULARITY VARCHAR2(40)
);
