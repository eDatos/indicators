...
ALTER TABLE TBL_INDICATOR_INSTANCES ADD CONSTRAINT FK_TBL_INDICATOR_INSTANCES_T06
...
ALTER TABLE TBL_ELEMENTS_LEVELS ADD CONSTRAINT FK_TBL_ELEMENTS_LEVELS_INDIC58
	FOREIGN KEY (INDICATOR_INSTANCE_FK) REFERENCES TBL_INDICATOR_INSTANCES (ID)
;
