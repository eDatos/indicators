...
CREATE TABLE TB_DATA_SOURCES (
  ID NUMBER(19) NOT NULL,
  QUERY_UUID VARCHAR2(255 CHAR) NOT NULL,
  QUERY_URN VARCHAR2(255 CHAR) NOT NULL,
...
;
ALTER TABLE TB_DATA_SOURCES ADD CONSTRAINT FK_TB_DATA_SOURCES_STAT_RESO82
