...
ALTER TABLE TB_IND_VERSION_MEAS_COV DROP CONSTRAINT FK_TB_IND_VERSION_MEAS_COV_INDICATOR_VERSION_FK;
ALTER TABLE TB_IND_VERSION_MEAS_COV ADD CONSTRAINT FK_TB_IND_VERSION_MEAS_COV_INDICATOR_VERSION_FK FOREIGN KEY (INDICATOR_VERSION_FK) REFERENCES TB_INDICATORS_VERSIONS (ID) ON DELETE CASCADE;