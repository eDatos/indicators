...
public class IndicatorsDataServiceTest extends IndicatorsBaseTest implements IndicatorsDataServiceTestBase {
    ...
    public void initMock() throws MetamacException {
        doReturn(JSON_CONSULTA1_STRUC).when(indicatorsDataProviderService).retrieveDataStructureJson(Matchers.any(ServiceContext.class), Matchers.same(UUID_CONSULTA1));
    }
