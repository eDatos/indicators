...
public class TimeVariableUtils {
    ...
    private static String  TIME_GRANULARITY_PATTERN = YEARLY_PATTERN + "|" + BIYEARLY_PATTERN + "|" + QUARTERLY_PATTERN + "|" + MONTHLY_PATTERN + "|" + WEEKLY_PATTERN + "|" + DAILY_PATTERN;

    private static Pattern pattern                  = Pattern.compile("^" + TIME_GRANULARITY_PATTERN + "$");
