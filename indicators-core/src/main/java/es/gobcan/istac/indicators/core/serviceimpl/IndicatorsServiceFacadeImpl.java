...
public class IndicatorsServiceFacadeImpl extends IndicatorsServiceFacadeImplBase {
    ...
    public MetamacCriteriaResult<IndicatorsSystemSummaryDto> findIndicatorsSystems(ServiceContext ctx, MetamacCriteria criteria) throws MetamacException {
        ...
        // Transform
        MetamacCriteriaResult<IndicatorsSystemSummaryDto> dtoResult = sculptorCriteria2MetamacCriteriaMapper.pageResultToMetamacCriteriaResultIndicatorsSystemSummary(result, sculptorCriteria.getPageSize());
        return dtoResult;
    }
    ...
    public MetamacCriteriaResult<IndicatorSummaryDto> findIndicators(ServiceContext ctx, MetamacCriteria criteria) throws MetamacException {
        ...
        // Transform
        MetamacCriteriaResult<IndicatorSummaryDto> metamacCriteriaResult = sculptorCriteria2MetamacCriteriaMapper.pageResultToMetamacCriteriaResultIndicatorSummary(result, sculptorCriteria.getPageSize());
        return metamacCriteriaResult;
    }
